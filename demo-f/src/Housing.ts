import {processSliderGroup} from "./global";


declare var document: any;

export default function (){
    let slider: any = document.querySelector("#housing-slider-member-pct");
    ...
    processSliderGroup(pCTValueBox, slider, totalSum, eles);
}